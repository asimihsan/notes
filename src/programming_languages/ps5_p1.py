...
<ul>
  ...
  <li>Text can be <b>bold (B)</b>, <i>italic (I)</i>, <small>small (SMALL)</small>, <big>big (BIG)</big>, or look like a <tt>typewriter</tt></li>
  <li>There are also ordered lists that use (OL) tags. Let's make one nested inside our current list item.
    <ol>
      <li>Text can also be <strong>strong (STRONG)</strong> or <em>emphasized</em>, which typically renders like bold and italics.</li>
      <li>Web pages can have <a href="http://dummy.domain">hyperlinks (A HREF="target")</a>.</li>
    </ol>
  </li>
