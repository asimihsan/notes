...
# optparams is a comma-separated list of zero or more identifiers. The
# parse tree for optparams is the list of all of the identifiers.
def p_opt_params_params(p):
    'optparams : params'
    p[0] = p[1]
def p_opt_params_empty(p):
    'optparams : '
    p[0] = [ ]

def p_params_params(p):
    'params : IDENTIFIER COMMA params'
    p[0] = [p[1]] + p[3]
def p_params_identifier(p):
    'params : IDENTIFIER'
    p[0] = [p[1]]
...
# Multiple top-level elements, each of which is a var, assignment or
...
jstext5 = """var view = right;"""
jstree5 = [('stmt', ('var', 'view', ('identifier', 'right')))]
print '-' * 20 + ' jstext5 ' + '-' * 20
print test_parser(jstext5) == jstree5
print test_parser(jstext5)
print '-' * 20 + ' jstext5 ' + '-' * 20

# Simple assign statement using another identifier
jstext6 = """i = j;"""
jstree6 = [('stmt', ('assign', 'i', ('identifier', 'j')))]
print '-' * 20 + ' jstext6 ' + '-' * 20
print test_parser(jstext6) == jstree6
print test_parser(jstext6)
print '-' * 20 + ' jstext6 ' + '-' * 20

# Two simple var statements
jstext7 = """var view = right;
             var x = y;"""
jstree7 = [('stmt', ('var', 'view', ('identifier', 'right'))),
           ('stmt', ('var', 'x', ('identifier', 'y')))]
print '-' * 20 + ' jstext7 ' + '-' * 20
print test_parser(jstext7) == jstree7
print test_parser(jstext7)
print '-' * 20 + ' jstext7 ' + '-' * 20
