...
def t_NUM_hex(token):
    r'0x[0-9a-f]+'
    token.value = int(eval(token.value)) # cheeky!
    token.type = 'NUM'
    return token
...
print test_lexer(question6) == [('NUM', 5), ('ID', 'is'), ('NUM', 5)]
print '---'

question7 = "0 is 0x0"
print '---'
print test_lexer(question7)
print test_lexer(question7) == [('NUM', 0), ('ID', 'is'), ('NUM', 0)]
print '---'

question8 = "tricky 0xabc0x"
print '---'
print test_lexer(question8)
print test_lexer(question8) == [('ID', 'tricky'), ('NUM', 43968), ('ID', 'x')]
print '---'
